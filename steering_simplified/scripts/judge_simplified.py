...
Prerequisites:
  - steering_results_simplified/steering_full_results.csv (from steering_experiment.py)
...
Outputs:
  - steering_results_simplified/steering_judged.csv  (adds baseline_correct, steered_correct columns)
  - steering_results_simplified/correctness_summary.csv  (per-combo flip rates)
"""
...
INPUT_CSV = Path("steering_results_simplified/steering_full_results.csv")
OUTPUT_CSV = Path("steering_results_simplified/steering_judged.csv")
SUMMARY_CSV = Path("steering_results_simplified/correctness_summary.csv")
